...
urlpatterns = [
    ...
    path("export/database.sql", DatabaseSQLExportAPIView.as_view()),
    path("dashboard/summary/", DashboardSummaryAPIView.as_view()),
    path("history/", HistoryAPIView.as_view()),
    path("planning/import-html/", PlanningHtmlImportAPIView.as_view()),
